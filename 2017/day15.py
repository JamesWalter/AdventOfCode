""" Advent of Code 2017 Day 17 Dueling Generators """
...
def solve1(start_a, start_b):
    a = start_a
    b = start_b
    total = 0
    for ___ in range(40000000):
        a = a * 16807 % 2147483647
        b = b * 48271 % 2147483647
        a_tail = int(bin(a)[2:].zfill(32)[-16:], 2)
        b_tail = int(bin(b)[2:].zfill(32)[-16:], 2)
        if a_tail ^ b_tail == 0:
            total += 1
...
# comparing them (using the same comparison method as before). It keeps
# track of the order it receives values; the first values from each
...
def solve2(start_a, start_b):
    a = start_a
    b = start_b
    total = 0
    for ___ in range(5000000):
        a = a * 16807 % 2147483647
        while a % 4 != 0:
            a = a * 16807 % 2147483647
        b = b * 48271 % 2147483647
